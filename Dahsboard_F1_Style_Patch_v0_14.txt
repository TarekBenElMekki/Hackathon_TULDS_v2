...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â¯ FEATURES:" -ForegroundColor Cyan
Write-Host "  ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Absolutely NO SCROLL (Vertical/Horizontal) - Full viewport fit" -ForegroundColor White
Write-Host "  ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ F1 TV Broadcast Style with scanlines, vignette & glowing effects" -ForegroundColor White
Write-Host "  ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Immersive Carbon Fiber background with dynamic racing gradient" -ForegroundColor White
Write-Host "  ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ All tables are fully visible within their containers (no cropping)" -ForegroundColor White
Write-Host "  ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Professional race control ticker at bottom" -ForegroundColor White
