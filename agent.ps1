      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "20px" }}>
          <div style={{ background: "rgba(30,30,40,0.95)", border: "1px solid rgba(225,6,0,0.3)", borderRadius: "8px", padding: "20px" }}>
            ...
            <button onClick={pushMessage} style={{ width: "100%", background: "linear-gradient(135deg, #E10600, #8B0000)", border: "none", color: "white", padding: "12px", borderRadius: "5px", cursor: "pointer", fontWeight: "bold" }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â¢ PUSH TO DASHBOARD</button>
          </div>
          <div style={{ background: "rgba(30,30,40,0.95)", border: "1px solid rgba(225,6,0,0.3)", borderRadius: "8px", padding: "20px" }}>
          ...
          <div style={{ background: "rgba(30,30,40,0.95)", border: "1px solid rgba(225,6,0,0.3)", borderRadius: "8px", padding: "20px" }}>
            ...
            <button onClick={showGif} style={{ width: "100%", background: "linear-gradient(135deg, #E10600, #8B0000)", border: "none", color: "white", padding: "12px", borderRadius: "5px", cursor: "pointer", fontWeight: "bold" }}>ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â¬ SHOW RANDOM GIF</button>
          </div>
          <div style={{ background: "rgba(30,30,40,0.95)", border: "1px solid rgba(225,6,0,0.3)", borderRadius: "8px", padding: "20px" }}>
          ...
          <div style={{ background: "rgba(30,30,40,0.95)", border: "1px solid rgba(225,6,0,0.3)", borderRadius: "8px", padding: "20px" }}>
            ...
            <button onClick={triggerSafetyCar} style={{ width: "100%", background: "#FFD700", color: "#000", padding: "12px", borderRadius: "5px", cursor: "pointer", fontWeight: "bold", border: "none", marginBottom: "10px" }}>ÃƒÂ°Ã…Â¸Ã…Â¡Ã‚Â¨ DEPLOY SAFETY CAR</button>
            <button onClick={triggerFastestLap} style={{ width: "100%", background: "#00D26A", color: "#000", padding: "12px", borderRadius: "5px", cursor: "pointer", fontWeight: "bold", border: "none", marginBottom: "10px" }}>ÃƒÂ¢Ã…Â¡Ã‚Â¡ FASTEST LAP</button>
            <button onClick={triggerPitStop} style={{ width: "100%", background: "#FF6B35", color: "#000", padding: "12px", borderRadius: "5px", cursor: "pointer", fontWeight: "bold", border: "none" }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂºÃ…Â¾ PIT STOP</button>
          </div>
        </div>
...
Write-Host "  ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Position Change Animations (up/down indicators)" -ForegroundColor White
Write-Host "  ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Overtake Detection with visual/audio feedback" -ForegroundColor White
Write-Host "  ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Highlight Reel with auto-capture of race events" -ForegroundColor White
Write-Host "  ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ F1 TV Style Broadcast Graphics" -ForegroundColor White
